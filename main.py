...
my_cloud = Prop('clouds.png', [0, -100])
...
while running:
    ...
    if timer <= 0:
        ...
        currentTimer = normalfont.render("Time left: " + str("{:.0f}".format(timer)), 1, (255, 0, 0))
    else:
        currentTimer = normalfont.render("Time left: " + str("{:.0f}".format(timer)), 1, (169, 169, 169))
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:                                    
            ...
            if event.key == pygame.K_SPACE and spacePresses > spaceRemembered:
                ...
                my_drone = Drone('droneshield.png', [0.5,0], [oldPosition -114, DRONE_Y-33])       
